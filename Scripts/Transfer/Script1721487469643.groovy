...
Mobile.tap(findTestObject('Object Repository/Flows/android.widget.TextView - Other Banks'), 0)

Mobile.tap(findTestObject('Object Repository/Flows/android.widget.EditText - Select Bank'), 0)

Mobile.sendKeys(findTestObject('Object Repository/Flows/android.widget.EditText (1)'), 'Thrive')

Mobile.tap(findTestObject('Object Repository/Flows/android.widget.TextView - THRIVE TEST'), 0)

Mobile.tap(findTestObject('Object Repository/Flows/android.widget.EditText - Enter account number (3)'), 0)

Mobile.sendKeys(findTestObject('Object Repository/Flows/android.widget.EditText - Enter account number (4)'), '0051762787')

Mobile.tap(findTestObject('Object Repository/Flows/android.widget.EditText - 0.00 (3)'), 0)

Mobile.sendKeys(findTestObject('Object Repository/Flows/android.widget.EditText - 0.00 (2)'), '10.00')

Mobile.tap(findTestObject('Object Repository/Flows/android.widget.TextView - Bank'), 0)

Mobile.scrollToText('Proceed')

Mobile.delay(3)

Mobile.tap(findTestObject('Object Repository/Flows/android.widget.TextView - Proceed (3)'), 0)
